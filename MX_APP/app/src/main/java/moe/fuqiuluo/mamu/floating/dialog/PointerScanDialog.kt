...
/**
 * 指针扫描对话框
 * 用于输入Target address并启动指针扫描，扫描Completed后将结果作为 PointerChainResultItem 返回
 */
class PointerScanDialog(
    ...
    private fun onScanCompleted(maxResults: Int) {
        ...
        // 使用通知显示结果
        notification.showSuccess("Scan complete: found $chainCount pointer chains\nResults saved to: $outputFile")
