...
class FastScrollerView @JvmOverloads constructor(
    ...
    companion object {
        private const val SCROLLBAR_WIDTH = 24f // 滚动条宽度（增大To 24dp）
        ...
        private const val FADE_DELAY = 2000L // 淡出延迟（增加To2秒）
    ...
    private fun scrollToPositionInternal(y: Float) {
        ...
        // 滚动To目标位置（不会触发 onScrolled，所以不需要额外的 updateThumbPosition）
