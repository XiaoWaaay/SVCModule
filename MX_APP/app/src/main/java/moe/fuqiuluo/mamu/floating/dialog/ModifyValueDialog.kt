...
class ModifyValueDialog : BaseDialog {
    ...
    override fun setupDialog() {
        ...
        binding.btnGoto.setOnClickListener {
            ...
            notification.showSuccess("Jumped to address: ${String.format("%X", address)}")
            dialog.dismiss()
        }
