...
fun TutorialPracticeScreen(
    ...
    // 定期FromMemory读取值（检测用户是否通过悬浮窗修改了值）
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Single-value Search Practice") },
                navigationIcon = {
            ...
            Column(
                ...
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            text = "Use the value shown below, search for its memory address from the floating window, and change it to 114514.",
                ...
                Card(
                    ...
                    Column(
                        ...
                        val steps = listOf(
                            ...
                            "Select the process: moe.fuqiuluo.mamu (PID: ${LocalMemoryOps.getPid()})",
                            "Search for the current value: $currentValue",
                            "Use the +1/-1 buttons to change the value",
                            "Search for the new value to refine the results",
                            "Repeat until only one address remains",
                            "Change that address to 114514"
                        )
                        ...
                        SelectionContainer {
                            Text(
                                text = if (memoryAddress != 0UL) {
                                    // 屏蔽 MTE/TBI 标签，只显示低 48 位有效Address
                        ...
                        Column(
                            ...
                            Row(
                                ...
                                Column {
                                    ...
                                    Text(
                                        text = "You have learned the basics of single-value searching and editing.",
                                        style = MaterialTheme.typography.bodySmall,
                                        color = MaterialTheme.colorScheme.onPrimaryContainer
                                    )
                                }
                            ...
                            Button(
                                ...
                                Text("Continue to the pointer-chain lesson")
                            }
                        }
                    }
                }
