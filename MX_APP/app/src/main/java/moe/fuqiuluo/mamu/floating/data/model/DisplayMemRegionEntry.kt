...
data class DisplayMemRegionEntry(
    ...
    companion object {
        ...
        /**
         * From MemRegionEntry 创建 DisplayMemRegionEntry
         *
         * @deprecated 请使用 DevideMemRange.kt 中的 divideToSimpleMemoryRange() 扩展Functions，
         * 它包含更完整和准确的MemoryRange分类逻辑
         */
        @Deprecated(
        ...
        /**
         * 根据Memory区域信息判断其所属的 MemoryRange 类型
         *
         * @deprecated 此方法的逻辑不完整。请使用 DevideMemRange.kt 中的 classifyRegion() Functions，
         * 它包含更详细的判断规则和边界情况处理
         */
        @Deprecated(
